...
verify-client-cert none
      # OpenVPN 2.5+: verify-client-cert none replaces removed client-cert-not-required
script-security 3
max-clients 1024
...
AUTH_URL="https://ddxvpn.org/database/api/auth.php"       # authentication
CONNECT_URL="https://ddxvpn.org/database/api/connect.php" # user connect tracking
DISCONNECT_URL="https://ddxvpn.org/database/api/disconnect.php" # user disconnect tracking
EOM
...
install_iptables
install_rclocal
systemctl enable openvpn@server openvpn@server2
install_done
