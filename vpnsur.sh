...
AUTH_URL="https://lmcapryn.com/database/api/auth.php"       # authentication
CONNECT_URL="https://lmcapryn.com/database/api/connect.php" # user connect tracking
DISCONNECT_URL="https://lmcapryn.com/database/api/disconnect.php" # user disconnect tracking
EOM
