...
AUTH_URL="https://panel.cybervpn.co.uk/database/api/auth.php"       # authentication
CONNECT_URL="https://panel.cybervpn.co.uk/database/api/connect.php" # user connect tracking
DISCONNECT_URL="https://panel.cybervpn.co.uk/database/api/disconnect.php" # user disconnect tracking
EOM
...
iptables -A INPUT -p udp --dport 5151 -j ACCEPT
